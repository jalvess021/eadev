...
if($resultado){
    echo "<script>window.location.href = '/eadev/plataforma.php?content_alu=perfil&msgs=1';</script>";
    mysqli_close($con);
}else{
    echo "<script>window.location.href = '/eadev/plataforma.php?msgs=2';</script>";
    mysqli_close($con);
}
