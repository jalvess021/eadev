                ...
                if (isset($_GET['aula'])) {
                    ...
                    $infoAula = mysqli_fetch_array($sqlAula);
                        if ((mysqli_num_rows($sqlAula) > 0)) {
                            echo "
                                <div class='all-play-aula '>
                                    <div class='video-play-aula'>
                                        <div class='iframe-play-aula'>
                                        ...
                                        <div class='infos-play-aula'>
                                            <div class='description-play-aula'>
                                                <div class='description-play-aula1'>
                                                    <a class='link-description-play-aula' href='?page=play_curso&curso=".$infoCur['sigla_curso']."'> <p >".$infoCur['sigla_curso']."</p> </a>
                                                    <i class='bi bi-chevron-right icon-description-play-aula'></i>
                                                    <p class='int-description-play-aula'>".$infoCur['nome_curso']."</p>
                                                </div>
                                                <h4 class='name-description-play-aula'>".$infoAula['tit_aula']."</h4>
                                            </div>
                                            <div class='buttons-play-aula'>
                                                <div id='area-con'></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class='all-cursos'>
                                        <div class='description-view-cur'>
                                            <a href='?page=play_curso&curso=".$infoCur['sigla_curso']."' class='description-back-cur' data-bs-toggle='tooltip' data-bs-placement='top' data-bs-title='Voltar p/ área do curso'>
                                                <i class='bi bi-reply-all-fill'></i> ".$infoCur['nome_curso']."</h4>
                                            </a>
                                            <p class='description-subtitle-view'> Vídeo aula - ( Via Youtube )</p>
                                            <p class='description-text-view'>".$infoCur['desc_curso']."</p>
                                            <hr class='description-line-view'>
                                        </div>
                                        <div class='all-cur-aulas'> ";
                                ...
                                while ($infoMod = mysqli_fetch_array($sqlMod)) {
                                    ...
                                    $sqlAula1 = mysqli_query($con, "SELECT * from aula where id_mod = ".$infoMod['id_mod'].";");
                                        while ($infoAula1 = mysqli_fetch_array($sqlAula1)) {
                                            echo "
                                            <a class='cur-view-aula' <a href='?page=play_video&curso=".$infoCur['sigla_curso']."&aula=".$infoAula1['id_aula']."'>
                                   ...
                                   echo "   
                                                <span class='play-cur-view'><i class='bi bi-play-circle'></i></span>
                                            </a>";
...
<script> 
        ...
        setInterval(() => {
            if (<?php echo $infoAulaAlu['status_aula'];?> === 1 && $("#form-concluir").html() == null) {
                $('#area-con').html("<form id='form-concluir'><button type='submit' form='form-concluir' class='button-conc' id='bt-concluir'>Concluir</button></form>");
                ...
                $('#area-con').html("<button class='button-conc1' id='bt-concluido' disabled>Concluída <i class='bi bi-patch-check-fill'></i></button>");
            }
        }, 0); 
</script> 
</html>