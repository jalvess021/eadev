...
// Selecionando a formação (1=Front-End) para setar na tabela matriculado
$sql5 = "select id_formacao from formacao where id_formacao = 1; ";
$res5 = mysqli_query($con, $sql5) or die(mysqli_error($con));
$info3 = mysqli_fetch_array($res5);
// Inserindo valores na tabela Matriculado
$sql6 = "insert into matriculado values (0, NOW(), 1, NULL, NULL, NULL, '". $info2[0] ."', '". $info3[0] ."'); ";
