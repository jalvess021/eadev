        ...
        <div class='modal fade' id='modalDeleteMod' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true' data-backdrop='static'>
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <div class='modal-header bg-danger text-white'>
                    <h5 class='modal-title' id='exampleModalLabel'> <i class='bi bi-exclamation-circle-fill'></i> Exclusão do módulo: <span class='text-uppercase font-weight-bold'>".$tipoMod."</span></h5>
                ...
                <div class='modal-body bg-light'>
                        <div class='form-group d-flex flex-column'>
                            ...
                            <small class='mb-2'>Digite o nome do módulo selecionado (<span class='text-danger font-weight-bold'> ".$tipoMod."</span> ) para continuar!</small>
                        ...
                        <div class='form-check mt-3'>
                            ...
                            Compreendo que TODOS os items relacionados ao módulo ".$tipoMod." serão deletados PERMANENTEMENTE!
                            </label>
                        </div>
                </div>
