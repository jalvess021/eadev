<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel='stylesheet' href='assets/css/all-rel/info_admin.css'>
    </head>
    <body>
      <header class='container-fluid'>
        <div class='d-flex flex-row justify-content-center'>
          <img class='icon-rel' src='arquivos/img/logo/logo1.png' alt=''>
        </div>
              ...
              <thead style='background-color: #343a40;'>
                <tr class='thead'>
                  <th style='border-right:none;'>
                    <img class='person-admin' src='arquivos/img/agnaldo.jfif' alt="">
                  </th>
                  <th >
      ...
      <footer class='container-fluid' style='width: 100%;position: absolute; bottom: 0; left: 0;''>
        ...
        <div class='d-flex flex-row justify-content-between'>
          <img class='footer-icon' src='arquivos/img/icone/icone1.png' alt=''>
