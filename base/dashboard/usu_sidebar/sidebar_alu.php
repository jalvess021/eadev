...
<div class="sidebar-inner leftscroll b-dark">
			...
			<ul>
                    ...
                    <li class="submenu">
                        <a href="?content_alu=conteudo"><i class="bi bi-collection-play-fill"></i><span> Conteúdo</span></a>   
                    </li>
					...
					<li class="submenu">
                        <a class="pro" href="#"></span><span class="label radius-circle bg-primary float-right">Premium</span><i class="bi bi-award-fill"></i><span> Certificado </span> </a>
                            <ul class="list-unstyled">			
                                <li><a href="?content_alu=emissao_certificado"><i class="bi bi-card-checklist"></i>Emissão</a></li>			
                                <li><a target="_blank" href="?page=validacao_certificado"><i class="bi bi-upc"></i>Validação</a></li>
                            </ul>
                    </li>
