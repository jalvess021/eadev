<?php
  ...
  require '../vendor/autoload.php';
    ...
    <head>
        ...
        <link rel='stylesheet' href='http://localhost/eadev/assets/css/all-rel/atv_admin.css'>
    </head>
    <body>";
      ...
      <table class='tb-ftecnica'>
        <thead>
            <tr class='thead'>
                ...
                <img class='person-admin' src='http://localhost/eadev/arquivos/img/agnaldo.jfif' alt=''>
                </th>
                <th >
        ...
        <tbody>
          ...
          <tr>
            <td class='resp-rel2 text-center' style='border: 1px solid black;'>2140</td>
