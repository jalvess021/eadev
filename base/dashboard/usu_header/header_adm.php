...
<div class="headerbar-left bg-light">
			<a href="index.html" class="logo"><img alt="Logo" id="logo-headerbar" src="arquivos/img/logo/logo1.png" />
            </a>
        </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notif">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
                                    <h5 class="text-overflow"><small>Olá, Admin...</small> </h5>
                                </div>

                                <!-- item-->
                                <a href="?content_adm=perfil" class="dropdown-item notify-item">
