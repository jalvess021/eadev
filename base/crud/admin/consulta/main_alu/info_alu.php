                ...
                <div class='row justify-content-start row-init'>
                        ...
                        <div class=' col-2 col-xl-3 mt-3'>
                            <div class='d-flex flex-row justify-content-end'>
                                <a href='/tcc/relatorios/loads/load_alu.php?' target='_blank' class='btn btn-sm btn-secondary mr-xl-4 mr-2 text-white font-weight-bold' data-toggle='tooltip' data-placement='top' title='Gerar Relatório'><i class='bi bi-file-earmark-person-fill'></i><span class='d-none d-xl-inline'> Ficha  Técnica </span></a>
                            <div>
