<?php
   ...
   if (isset($_GET['user'])) {
        ...
        if ($rows === 1) {
                ...
                $sql = mysqli_query($con, "SELECT * from atv_adm where id_adm = ".$infoUser['id_usu']." order by dt_atv desc limit $inicio, $quantidade;");
                    ...
                    echo "
                            <div class='d-flex flex-row justify-content-between align-items-center mb-3 div-lb-cons'>
                                ...
                                <div class='d-flex flex-row'>
                                    <a href='/eadev/relatorios/rel_atv_adm.php?' target='_blank' class='btn btn-sm btn-secondary mr-3 text-white' data-toggle='tooltip' data-placement='left' title='Gerar Relatório Geral de Atividades do Adm { ".$user." }'><i class='bi bi-file-earmark-bar-graph-fill'></i> Relatório</a>
