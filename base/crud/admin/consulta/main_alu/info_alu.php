            ...
            <div class='div-border'>
                <div class='row justify-content-start row-init'>
                        <div class='col-2'>
                            ...
                            $arq = "\\eadev\assets\images\users\\".md5($resAlu['id_usu']).".jpeg";
                            if (file_exists($_SERVER['DOCUMENT_ROOT']."/eadev/assets/images/users/".md5($resAlu['id_usu']).".jpeg")) {
                               echo $arq;
                            }else {
                        ...
                        <div class=' col-2 col-xl-3 mt-3'>
                            <div class='d-flex flex-row justify-content-end'>
                                <a href='/eadev/relatorios/loads/ficha_alu_load.php?user=".$_GET['alu']."' target='_blank' class='btn btn-sm btn-secondary mr-xl-4 mr-2 text-white font-weight-bold' data-toggle='tooltip' data-placement='top' title='Gerar Relatório'><i class='bi bi-file-earmark-person-fill'></i><span class='d-none d-xl-inline'> Ficha  Técnica </span></a>
                            <div>
