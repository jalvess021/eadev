		...
		<!-- ÁREA DE ATUALIZAÇÃO DAS PÁGINAS VIA **** AJAX **** -->
			<div id="content-page">
				<div id="main" class="container-fluid">
					<h3 class="page-header">Editar meu perfil</h3>
					
					<!-- Área de campos do formulário de edição-->
					<form action="?content_alu=atualiza" method="POST" class="b-wsmoke p-md-3 rounded border border-secondary">
						...
						<div id="actions" class="row justify-content-center">
							<div class="col-md-3">
								<div class="row justify-content-around">
									...
									<a href="?content_alu=perfil" class="btn btn-info btn-lg">Voltar</a>
