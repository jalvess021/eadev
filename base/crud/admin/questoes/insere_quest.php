<?php
    ...
    if($res){
            ...
            if ($usu_atv) {
                echo "<script>window.location.href = '/eadev/plataforma.php?content_adm=lista_quest&msg=16';</script>";
                mysqli_close($con);
            }else{
                echo "<script>window.location.href = '/eadev/plataforma.php?content_adm=lista_quest&msg=6';</script>";
                mysqli_close($con);
            }
    } 
?>