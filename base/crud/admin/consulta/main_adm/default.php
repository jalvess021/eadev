    ...
    <div class='d-flex flex-row justify-content-between mb-3'>
        <h6 class='lb-cons'>Lista de administradores</h6>
            <a class='btn btn-sm btn-secondary text-white' data-toggle='tooltip' data-placement='left' title='Gerar Relatório Geral de Administradores'><i class='bi bi-file-earmark-bar-graph-fill'></i> Relatório</a>
      </div>
				<?php
						$quantidade = 3;
